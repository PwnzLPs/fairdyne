...
var undying_breastplate_texture;
var undying_skirt_texture;
var undying_legs_texture;
var undying_rightarm_texture;
var undying_leftarm_texture;
var undying_hair_textures = Array(4);
...
function Undyne_The_Undying() {
	...
	this.hair_sprite = new PIXI.Sprite(undying_hair_texture);
...
Undyne.prototype.selectNextText = function() {
	...
	if (this.text_queue.length > 0) {
		...
		if (this.sbtext.face) {
			this.head_sprite.texture = undying_head_textures[this.sbtext.face];
		} else {
			this.head_sprite.texture = undying_head_textures[0];
		}
	} else {
		this.head_sprite.texture = undying_head_textures[0];
		this.sbtext = null;
